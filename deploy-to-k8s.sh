...
function show_usage {
  ...
  echo "  -r, --registry REGISTRY    Docker registry to use (default: registry.cloudraya.com/ir-cr-agatha-4331)"
...
sed -i.bak "s|image: registry.cloudraya.com/ir-cr-agatha-4331/customer-app.*|image: $REGISTRY/customer-app:$TAG|g" k8s/deployment.yaml
sed -i.bak "s|image: registry.cloudraya.com/ir-cr-agatha-4331/customer-app.*|image: $REGISTRY/customer-app:$TAG|g" k8s/deployment-with-pvc.yaml

# Update image reference in skaffold.yaml
sed -i.bak "s|image: registry.cloudraya.com/ir-cr-agatha-4331/customer-app|image: $REGISTRY/customer-app|g" skaffold.yaml

# Update image reference in pom.xml
sed -i.bak "s|<image>registry.cloudraya.com/ir-cr-agatha-4331/customer-app</image>|<image>$REGISTRY/customer-app</image>|g" pom.xml
